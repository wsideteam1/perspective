...
export interface PerspectiveWidgetOptions {
    dark?: boolean;
    bindto?: HTMLElement;
}
...
export class PerspectiveWidget extends Widget {
    ...
    set computed_columns(computed_columns: Array<{[colname: string]: string}>) {
    ...
    constructor(name = "Perspective", options: PerspectiveViewerOptions & PerspectiveWidgetOptions = {}) {
     ...
     * @param options
     */
    public _set_attributes(options: PerspectiveViewerOptions & PerspectiveWidgetOptions) {
        const plugin: string = options.plugin || "hypergrid";
        const columns: string[] = options.columns || [];
        const row_pivots: string[] = options.row_pivots || [];
        const column_pivots: string[] = options.column_pivots || [];
        ...
        const computed_columns: Array<{[colname: string]: string}> = options.computed_columns || [];
        const plugin_config: any = options.plugin_config || {};
     ...
     *
     */
    public onAfterShow(msg: Message): void {
        this.notifyResize();
    ...
    public restore(config: any): Promise<void> {
     ...
     */
    public load(table: TableData | Table): void {
...
namespace Private {
    ...
    export function createNode(node: HTMLDivElement): PerspectiveViewer {
        ...
        const viewer = (document.createElement("perspective-viewer") as any) as PerspectiveViewer;
